...
This MSC thesis project explores how an agentic workflow can preprocess datasets in the most cost-efficient way while also
keeping performance. It utilizes **metadata** to describe the datasets rather than reading the whole dataset, this way lowering the amount of tokens fed into the models
